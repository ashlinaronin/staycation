stayCation.controller('MovablesCtrl', function MovablesCtrl($scope, $stateParams) {
  ...
  //     console.log("in mousemove, mouse.x is " + myState.getMouse(e).x + " and mouse.y is " + myState.getMouse(e).y);
  //
  //     if (myState.dragging){
  //       var mouse = myState.getMouse(e);
  ...
  //   this.valid = false;
  //   console.log("in CanvasState.addShape, this.shapes is " + this.shapes);
  // }
  //
  ...
  //
  //   //  console.log("i got to the draw function");
  //   if (!this.valid) {
  //     var ctx = this.ctx;
  ...
  //
  //
  //     console.log("i'm about to draw all the shapes");
  //     console.log("shapes in draw is " + shapes);
  //     var l = shapes.length;
  //     for (var i = 0; i < l; i++) {
  //       var shape = shapes[i];
